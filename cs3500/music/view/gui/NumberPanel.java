...
public class NumberPanel extends JPanel implements Scrollable{
     ...
     * components should handle a partially
     * exposed row or column by returning the distance required
     * to completely expose the item. <p>
     *     Scrolling containers, like JScrollPane, will use this
